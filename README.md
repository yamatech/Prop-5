...
なお、このプロジェクトの一部は、Google AntigravityによるAIコーディングを使用しております。  
...
その代わり、GPLv3ライセンスの範囲内において、完全なオープンソース（無料）プロジェクトとして、ユーザーが自由にフォークし、改良を加え、派生版（macOS版やLinux版のビルドなどを含む）を作成して配布することを大いに歓迎します。
